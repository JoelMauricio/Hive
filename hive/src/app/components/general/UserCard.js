...
export default function UserCard({ User, UserId }) {
    ...
    return (
        <div className='flex min-w-[100%] min-h-[65px] justify-between p-2 rounded-md border border-[rgba(102,102,102,1)]'  >
            < div className='flex items-center justify-start gap-4' onClick={openUser}>
